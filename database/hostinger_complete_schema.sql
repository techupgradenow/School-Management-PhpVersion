-- ========================================
-- EduManage Pro - Complete Schema for Hostinger
...
CREATE TABLE IF NOT EXISTS `activity_history` (
    ...
    `action` ENUM('ADD', 'UPDATE', 'DELETE', 'VIEW', 'EXPORT', 'IMPORT', 'LOGIN', 'LOGOUT', 'STATUS_CHANGE') NOT NULL,
    `old_data` JSON NULL,
    `new_data` JSON NULL,
...
('academic_year', '2024-2025', 'text'),
('currency', 'INR', 'text'),
('currency_symbol', '₹', 'text'),
('timezone', 'Asia/Kolkata', 'text'),
('institution_type', 'School', 'text');
...
('School', 'K-12 School Institution'),
...
INSERT IGNORE INTO `institution_settings` (`setting_key`, `setting_value`, `setting_type`, `description`) VALUES
('institution_type', '1', 'select', 'Type of institution (School or College)');
...
CREATE TABLE IF NOT EXISTS `dropdown_categories` (
    ...
    INDEX `idx_institution` (`institution_type_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `syllabus` (
    `id` INT AUTO_INCREMENT PRIMARY KEY,
    `syllabus_code` VARCHAR(50) UNIQUE NULL,
    `class` VARCHAR(50) NOT NULL,
